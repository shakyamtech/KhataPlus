        ...
        <div className="lg:col-span-6 w-full max-w-md mx-auto relative">
          <Card className="p-5 sm:p-6 shadow-2xl backdrop-blur-xl bg-white/80 dark:bg-card/75 border border-white/60 dark:border-white/10 rounded-2xl relative overflow-hidden transition-all duration-300">
            ...
            <div className="mb-4 pr-12">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-secondary/80 border border-border/50 text-[10px] font-semibold text-muted-foreground mt-2">
                <span className="flex items-center gap-0.5 text-foreground"><Laptop className="h-3 w-3 text-primary" /> Laptop</span>
                <span>·</span>
                <span className="flex items-center gap-0.5 text-foreground"><Smartphone className="h-3 w-3 text-primary" /> Mobile/Tab</span>
                <span>·</span>
                <span className="font-bold text-emerald-600 dark:text-emerald-400">Android & iOS</span>
              </div>
            </div>
